...
public class QOrderMenu extends EntityPathBase<OrderMenu> {
    ...
    private static final long serialVersionUID = -197048361L;
    ...
    public final study.querydsl.domain.menu.QMenu menu;
    ...
    public QOrderMenu(Class<? extends OrderMenu> type, PathMetadata metadata, PathInits inits) {
        ...
        this.menu = inits.isInitialized("menu") ? new study.querydsl.domain.menu.QMenu(forProperty("menu"), inits.get("menu")) : null;
